...
const deadline = {
    ...
    list:[
        {
            bullet: false,
            text: "Once you click the confirmation button below, you will have 72 hours to complete all the 5 tasks, which is recording 5 videos, one at a time."
        },
        {
            bullet: false,
            text: "Should you fail to send all the content within the deadline ..."
        },
        {
            bullet: false,
            text: "Also, failing to send all the videos will incur ..."
        },
    ]
}
const resources = {
...
const tips = {
    ...
    list:[
        {
            bullet: false,
            text: "Do not click below if you are not one hundred percent certain that you have all the required resources promptly available, remember, once you click below you will have 72 hours to complete the test."
        },
        {
            bullet: true,
            text: "Test the quality of your video and camera, your face must be well lit and on focus. If we are not able to see your face clearly, your videos might be unusable thus nullifying the process. This will affect the whole process, possibly placing you on a 45-day queue ."
        },
        {
            bullet: true,
            text: "Unless you are really confident, not only about your English levels but also about the hardware you will need to record and send the videos, use the first day to get acquainted to the model and content as well as practice and rehearse."
        },
    ]
}

card.push(basicInstruction)
card.push(deadline)
card.push(resources)
card.push(tips)
