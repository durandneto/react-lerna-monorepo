...
Click the “RECORD” button bellow to record a quick video and perform the tests." icon onClick={action()}/>
    ~~~
...
.add('VHIconTitleDescription without title',
  withInfo(`
    ...
    ~~~js
    <VHIconTitleDescription description="description withou title" icon={iconMaterial} onClick={action()}/>
    ~~~
